...
import com.example.wikipedia.databinding.FragmentTrendsBinding
import com.example.wikipedia.wiki_data


class Trends : Fragment(), Trends_recyclerview_adapter.Trends_events {
    ...
    private fun set_trends_recyclerview_adapter(list: List<wiki_data>) {
        val myAdapter = Trends_recyclerview_adapter(list, this)
        binding.trendsRecyclerview.adapter = myAdapter
        binding.trendsRecyclerview.layoutManager =
            LinearLayoutManager(binding.root.context, RecyclerView.VERTICAL, false)
    }

    override fun cardview_clickListner(wikiData: wiki_data) {
